...
public abstract class Lapack {
     ...
     * @param info
     */
    public final void sgeev(String jobvl, String jobvr, int n, float[] a, int lda, float[] wr, float[] wi, float[] vl,
            int ldvl, float[] vr, int ldvr, float[] work, int lwork, intW info) {
        sgeev(jobvl, jobvr, n, a, 0, lda, wr, 0, wi, 0, vl, 0, ldvl, vr, 0, ldvr, work, 0, lwork, info);
    }

    public abstract void sgeev(String jobvl, String jobvr, int n, float[] a, int aOffset, int lda, float[] wr,
     ...
     * @param info
     */
    public final void sgesdd(String jobz, int m, int n, float[] a, int lda, float[] s, float[] u, int ldu, float[] vt,
            int ldvt, float[] work, int lwork, int[] iwork, intW info) {
        sgesdd(jobz, m, n, a, 0, lda, s, 0, u, 0, ldu, vt, 0, ldvt, work, 0, lwork, iwork, 0, info);
    }

    public abstract void sgesdd(String jobz, int m, int n, float[] a, int aOffset, int lda, float[] s, int sOffset,
    ...
    public abstract void sgeqrf(int m, int n, float[] a, int aOffset, int lda, float[] tau, int tauOffset,
     ...
     * @param info
     */
    public final void sorgqr(int m, int n, int k, float[] a, int lda, float[] tau, float[] work, int lwork,
            intW info) {
        sorgqr(m, n, k, a, 0, lda, tau, 0, work, 0, lwork, info);
    }

    public abstract void sorgqr(int m, int n, int k, float[] a, int aOffset, int lda, float[] tau, int tauOffset,
            float[] work, int workOffset, int lwork, intW info);
    /**
     * <pre>
     * <code>
    ...
    public abstract void sgetrf(int m, int n, float[] a, int aOffset, int lda, int[] ipiv, int ipivOffset, intW info);
    ...
    public abstract int cgels(String trans, int m, int n, int nrhs, float[] a, int lda, float[] b, int ldb);
