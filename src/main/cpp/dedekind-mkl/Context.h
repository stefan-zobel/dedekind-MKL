...
#if !defined(__CONTEXT_H_INCLUDED_)
#define __CONTEXT_H_INCLUDED_
...
class __GCC_DONT_EXPORT Context : public JNIEnv_ {
...
public:
    ...
    jobject ToReflectedField(jclass clazz, jfieldID fieldID, jboolean isStatic);
...
#endif // !defined(__CONTEXT_H_INCLUDED_)
